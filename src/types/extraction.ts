...
export type CanonicalBundle = {
  ...
  invoice?: CanonicalGroupRecord | null
  invoiceLineItems?: Array<Record<string, unknown>> | null
  cmr?: CanonicalGroupRecord | null
  ub04?: CanonicalGroupRecord | null
  ub04LineItems?: Ub04LineItemTable[] | null
  [key: string]: unknown
}

export type CanonicalSection = 'facility_invoice' | 'cmr_form' | 'ub04' | 'unknown'
